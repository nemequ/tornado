...
typedef unsigned             MemSize;          // НАЗ╦Л ОЮЛЪРХ
typedef char*                FILENAME;         // ХЛЪ ТЮИКЮ
#ifdef FREEARC_LARGE_FILES
typedef uint64               FILESIZE;         // ПЮГЛЕП ТЮИКЮ
#else
...
// бНГПЮЫЮЕР ВХЯКНБНЕ ГМЮВЕМХЕ ЯХЛБНКЮ, ПЮЯЯЛЮРПХБЮЕЛНЦН ЙЮЙ ЬЕЯРМЮДЖЮРЕПХВМЮЪ ЖХТПЮ
